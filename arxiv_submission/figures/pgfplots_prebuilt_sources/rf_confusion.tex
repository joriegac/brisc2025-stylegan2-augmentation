...
\thispagestyle{empty}
\noindent
% --- Embedded source from figures/pgfplots/pgfplots_p015/P015_rf_v2_tumour_confusion_matrices.tex ---
...
\addplot[
  ...
  draw=white,
  line width=0.3pt
] table[x=x, y=y, meta=mean] {../pgfplots/pgfplots_p015/data/mean_confusion.dat};
\draw[black, line width=0.55pt] (axis cs:0.5,0.5) rectangle (axis cs:4.5,4.5);
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:1,4) {71.7 $\pm$ 0.6};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:2,4) {23.2 $\pm$ 1.5};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,4) {0.9 $\pm$ 0.2};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:4,4) {4.2 $\pm$ 0.9};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:1,3) {8.9 $\pm$ 0.5};
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:2,3) {62.0 $\pm$ 2.2};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,3) {6.8 $\pm$ 0.8};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:4,3) {22.2 $\pm$ 1.9};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:1,2) {0.2 $\pm$ 0.2};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:2,2) {0.0 $\pm$ 0.0};
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:3,2) {99.8 $\pm$ 0.2};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:4,2) {0.0 $\pm$ 0.0};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:1,1) {1.2 $\pm$ 0.2};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:2,1) {1.5 $\pm$ 0.6};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,1) {0.4 $\pm$ 0.2};
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:4,1) {96.9 $\pm$ 0.6};
\end{axis}
\end{tikzpicture}%
\end{adjustbox}
\endgroup

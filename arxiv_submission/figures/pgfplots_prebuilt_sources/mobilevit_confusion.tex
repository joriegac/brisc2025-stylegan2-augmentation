...
\thispagestyle{empty}
\noindent
% --- Embedded source from figures/pgfplots/pgfplots_p025_p026/P025_P026_mobilevitv2_confusion_matrices.tex ---
...
\addplot[
  ...
  draw=white,
  line width=0.3pt
] table[x=x, y=y, meta=mean] {../pgfplots/pgfplots_p025_p026/data/tumour_mean_confusion.dat};
\draw[black, line width=0.55pt] (axis cs:0.5,0.5) rectangle (axis cs:4.5,4.5);
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:1,4) {97.7 $\pm$ 0.4};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:2,4) {2.1 $\pm$ 0.5};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,4) {0.0 $\pm$ 0.1};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:4,4) {0.2 $\pm$ 0.1};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:1,3) {1.9 $\pm$ 0.5};
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:2,3) {83.9 $\pm$ 1.2};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,3) {11.8 $\pm$ 1.1};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:4,3) {2.5 $\pm$ 0.6};
...
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:1,1) {0.2 $\pm$ 0.1};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:2,1) {0.6 $\pm$ 0.2};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,1) {0.0 $\pm$ 0.0};
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:4,1) {99.2 $\pm$ 0.3};
\end{axis}
...
\addplot[
  ...
  draw=white,
  line width=0.3pt
] table[x=x, y=y, meta=mean] {../pgfplots/pgfplots_p025_p026/data/plane_mean_confusion.dat};
\draw[black, line width=0.55pt] (axis cs:0.5,0.5) rectangle (axis cs:3.5,3.5);
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:1,3) {99.7 $\pm$ 0.1};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:2,3) {0.3 $\pm$ 0.1};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,3) {0.0 $\pm$ 0.0};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:1,2) {1.3 $\pm$ 0.1};
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:2,2) {98.0 $\pm$ 0.5};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:3,2) {0.7 $\pm$ 0.3};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:1,1) {0.0 $\pm$ 0.0};
\node[align=center, font=\figtext, text=black, inner sep=0pt] at (axis cs:2,1) {0.6 $\pm$ 0.1};
\node[align=center, font=\figtext, text=white, inner sep=0pt] at (axis cs:3,1) {99.4 $\pm$ 0.1};
\end{axis}

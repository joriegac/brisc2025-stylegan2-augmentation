...
\thispagestyle{empty}
\noindent
% --- Embedded source from figures/pgfplots/pgfplots_p034_umap_class_v2/P034_umap_class_v2.tex ---
...
tick label style={font=\plotaxisfont},
  legend style={
    at={(0.5,1.08)},
    anchor=south,
    draw=none,

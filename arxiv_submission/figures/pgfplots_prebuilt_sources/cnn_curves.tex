...
\thispagestyle{empty}
\noindent
% --- Embedded source from figures/pgfplots/pgfplots_p023/P023_cnn_v2_training_validation_curves.tex ---
...
\addplot[name path=valid_loss_baseline_upper, draw=none, forget plot] table[x=epoch, y=vl_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_baseline.dat};
\addplot[name path=valid_loss_baseline_lower, draw=none, forget plot] table[x=epoch, y=vl_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_baseline.dat};
...
\addplot[black!72, line width=0.72pt] table[x=epoch, y=vl_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_baseline.dat};
\addlegendentry{Baseline}
\addplot[name path=valid_loss_augmented_r1_upper, draw=none, forget plot] table[x=epoch, y=vl_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r1.dat};
\addplot[name path=valid_loss_augmented_r1_lower, draw=none, forget plot] table[x=epoch, y=vl_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r1.dat};
...
\addplot[condAugOne, line width=0.72pt] table[x=epoch, y=vl_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r1.dat};
\addlegendentry{Augmented 1:1}
\addplot[name path=valid_loss_filtered_r1_upper, draw=none, forget plot] table[x=epoch, y=vl_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r1.dat};
\addplot[name path=valid_loss_filtered_r1_lower, draw=none, forget plot] table[x=epoch, y=vl_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r1.dat};
...
\addplot[condFiltOne, line width=0.72pt] table[x=epoch, y=vl_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r1.dat};
\addlegendentry{Filtered 1:1}
\addplot[name path=valid_loss_augmented_r2_upper, draw=none, forget plot] table[x=epoch, y=vl_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r2.dat};
\addplot[name path=valid_loss_augmented_r2_lower, draw=none, forget plot] table[x=epoch, y=vl_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r2.dat};
...
\addplot[condAugTwo, line width=0.72pt] table[x=epoch, y=vl_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r2.dat};
\addlegendentry{Augmented 1:2}
\addplot[name path=valid_loss_filtered_r2_upper, draw=none, forget plot] table[x=epoch, y=vl_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r2.dat};
\addplot[name path=valid_loss_filtered_r2_lower, draw=none, forget plot] table[x=epoch, y=vl_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r2.dat};
...
\addplot[condFiltTwo, line width=0.72pt] table[x=epoch, y=vl_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r2.dat};
...
\addplot[name path=valid_acc_baseline_upper, draw=none, forget plot] table[x=epoch, y=vl_tumour_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_baseline.dat};
\addplot[name path=valid_acc_baseline_lower, draw=none, forget plot] table[x=epoch, y=vl_tumour_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_baseline.dat};
...
\addplot[black!72, line width=0.72pt] table[x=epoch, y=vl_tumour_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_baseline.dat};
\addplot[name path=valid_acc_augmented_r1_upper, draw=none, forget plot] table[x=epoch, y=vl_tumour_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r1.dat};
\addplot[name path=valid_acc_augmented_r1_lower, draw=none, forget plot] table[x=epoch, y=vl_tumour_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r1.dat};
...
\addplot[condAugOne, line width=0.72pt] table[x=epoch, y=vl_tumour_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r1.dat};
\addplot[name path=valid_acc_filtered_r1_upper, draw=none, forget plot] table[x=epoch, y=vl_tumour_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r1.dat};
\addplot[name path=valid_acc_filtered_r1_lower, draw=none, forget plot] table[x=epoch, y=vl_tumour_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r1.dat};
...
\addplot[condFiltOne, line width=0.72pt] table[x=epoch, y=vl_tumour_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r1.dat};
\addplot[name path=valid_acc_augmented_r2_upper, draw=none, forget plot] table[x=epoch, y=vl_tumour_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r2.dat};
\addplot[name path=valid_acc_augmented_r2_lower, draw=none, forget plot] table[x=epoch, y=vl_tumour_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r2.dat};
...
\addplot[condAugTwo, line width=0.72pt] table[x=epoch, y=vl_tumour_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_augmented_r2.dat};
\addplot[name path=valid_acc_filtered_r2_upper, draw=none, forget plot] table[x=epoch, y=vl_tumour_q3] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r2.dat};
\addplot[name path=valid_acc_filtered_r2_lower, draw=none, forget plot] table[x=epoch, y=vl_tumour_q1] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r2.dat};
...
\addplot[condFiltTwo, line width=0.72pt] table[x=epoch, y=vl_tumour_median] {../pgfplots/pgfplots_p023/data/cnn_v2_loss_summary_filtered_r2.dat};
